...
<div class="container topup-container topup-page">
    ...
    <div class="topup-steps">
        ...
        <div class="panel topup-panel">
                ...
                <p class="topup-transfer-note">Transfer terlebih dahulu ke rekening: <strong>BRI 664701012881537 a.n. RUMAH TAHFIDZ BAITUL</strong>. Setelah transfer klik Lanjut untuk mengunggah bukti.</p>
